###########################################################################
## Makefile generated for Simulink model 'slexMulticoreSolverMdlref'. 
## 
## Makefile     : slexMulticoreSolverMdlref.mk
## Generated on : Wed Jan 17 08:51:58 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: .\slexMulticoreSolverMdlref_rtwlib.lib
...
PRODUCT_NAME              = slexMulticoreSolverMdlref
MAKEFILE                  = slexMulticoreSolverMdlref.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = slexMulticoreSolverMdlref_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..\..\..
MODELREF_LINK_RSPFILE     = slexMulticoreSolverMdlref_ref.rsp
GEN_LINKER_RESPONSE       = $(MATLAB_ARCH_BIN)\createResponseFile.exe 1 
CMD_FILE                  = $(PRODUCT_NAME).rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
MODELLIB                  = slexMulticoreSolverMdlref_rtwlib.lib
MODELREFS                 = 
MODELREF_LINK_LIBS        = 
...
PRODUCT = .\slexMulticoreSolverMdlref_rtwlib.lib
...
INCLUDES_BUILDINFO = $(START_DIR);$(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\slprj\grt\slexMulticoreSolverMdlref;$(MATLAB_ROOT)\toolbox\simulink\simdemos\simfeatures;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(START_DIR)\slprj\grt\_sharedutils
...
DEFINES_STANDARD = -DMODEL=slexMulticoreSolverMdlref -DNUMST=1 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\slprj\grt\slexMulticoreSolverMdlref\slexMulticoreSolverMdlref.c
...
OBJS = slexMulticoreSolverMdlref.obj
...
{$(START_DIR)\slprj\grt\slexMulticoreSolverMdlref}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\slprj\grt\slexMulticoreSolverMdlref}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
